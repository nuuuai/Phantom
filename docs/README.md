...
4. From the repo root: **`npm install`** then **`npm run dev`** for API + dashboard + extension dev, or follow the exact migrate/seed/lint/test/build order in [`roadmap/DEPLOYMENT.md`](./roadmap/DEPLOYMENT.md) **§ CI** for parity with GitHub Actions.
...
6. **Extension (optional):** `npm run build:extension:store`, then load the unpacked output in `chrome://extensions` (see [`roadmap/EXTENSION_STORE_BUILD.md`](./roadmap/EXTENSION_STORE_BUILD.md)).

Full production-like steps, CI parity, and env tables: [`roadmap/DEPLOYMENT.md`](./roadmap/DEPLOYMENT.md).
...
See [`architecture/TECH_STACK.md`](./architecture/TECH_STACK.md) for full details.
...
```
Phantom/
├── README.md                    # Short entry point → docs/
├── docs/                        # All documentation
│   ├── README.md                # Full project readme (this file)
│   ├── OVERVIEW.md              # Product vision and summary
│   ├── AI_ENHANCEMENT_ROADMAP.md # AI enhancement plan (all pages)
...
High-level only — full detail lives in [`roadmap/README.md`](./roadmap/README.md) and [`roadmap/PHASE_1_FOUNDATION.md`](./roadmap/PHASE_1_FOUNDATION.md).
...
- **Auth/vault policy** — **`roadmap/AUTH_AND_VAULT_PHASE1.md`** (JWT vs SRP/Argon2id); tenant boundary — **`architecture/USER_DATA_SCOPE.md`**.
- **Inbox + phone UX** — Email inbox **`q`** filter + dashboard search; phone provider **`lastError`** on generate + alias detail.
- **Broker removal** — Queue/worker direction — **`roadmap/BROKER_REMOVAL_QUEUE.md`**; Pro removal queue + **API-broker** UI labels (simulated automation).
...
- **Launch / AWS** — **`roadmap/INFRA_AWS_PHASE1.md`** (recommended AWS layout, health probes, prod parity); **`DEPLOYMENT.md`** links it; extension store docs include **manifest path** + prod parity table.
- **Email inbound** — **`phantom:v1:`** content hash dedupe when **`providerMessageId`** is omitted (worker retries); see **`roadmap/EMAIL_INBOUND.md`**.
...
**Agent playbook (sequential runs):** [`roadmap/PHASE_1_AGENT_RUNS.md`](./roadmap/PHASE_1_AGENT_RUNS.md).
...
Details, Postgres **`DATABASE_URL`** in Actions, and which tests are DB-gated: [`roadmap/DEPLOYMENT.md`](./roadmap/DEPLOYMENT.md) **§ CI** and [`.github/workflows/ci.yml`](../.github/workflows/ci.yml).
...
### Product & planning
- [`OVERVIEW.md`](./OVERVIEW.md) — Product vision and four-layer architecture
- [`AI_ENHANCEMENT_ROADMAP.md`](./AI_ENHANCEMENT_ROADMAP.md) — Page-by-page AI enhancement plan
...
- [`architecture/TECH_STACK.md`](./architecture/TECH_STACK.md) — Technology choices and rationale
- [`architecture/DATA_FLOWS.md`](./architecture/DATA_FLOWS.md) — How data moves through the system
- [`architecture/SECURITY_MODEL.md`](./architecture/SECURITY_MODEL.md) — Zero-knowledge encryption, vault design
- [`architecture/USER_DATA_SCOPE.md`](./architecture/USER_DATA_SCOPE.md) — Logical multi-tenancy (`userId`) in Phase 1

### Features
- [`features/LAYER_1_SHIELD.md`](./features/LAYER_1_SHIELD.md) — Defensive privacy features
- [`features/LAYER_2_BRAIN.md`](./features/LAYER_2_BRAIN.md) — Adaptive AI engine
- [`features/LAYER_3_SWORD.md`](./features/LAYER_3_SWORD.md) — Offensive counter-operations
- [`features/LAYER_4_AUTOPILOT.md`](./features/LAYER_4_AUTOPILOT.md) — Autonomous identity management
- [`features/SCAMMER_ENGAGEMENT_ENGINE.md`](./features/SCAMMER_ENGAGEMENT_ENGINE.md) — Deep dive on SEE
- [`features/BROWSER_EXTENSION.md`](./features/BROWSER_EXTENSION.md) — Extension architecture and UX

### Roadmap
- [`roadmap/PHASE_1_AGENT_RUNS.md`](./roadmap/PHASE_1_AGENT_RUNS.md) — Sequential agent prompts (Runs 1–5) + remaining Phase 1 checklist
- [`roadmap/PHASE_1_FOUNDATION.md`](./roadmap/PHASE_1_FOUNDATION.md) — Months 1–6: Dashboard + Extension
- [`roadmap/PHASE_2_INTELLIGENCE.md`](./roadmap/PHASE_2_INTELLIGENCE.md) — Months 6–12: AI + Threat Intel
- [`roadmap/PHASE_3_AUTONOMY.md`](./roadmap/PHASE_3_AUTONOMY.md) — Months 12–18: Autopilot + Advanced AI
- [`roadmap/PHASE_4_MOBILE_ECOSYSTEM.md`](./roadmap/PHASE_4_MOBILE_ECOSYSTEM.md) — Months 18–24: Mobile + Ecosystem
- [`roadmap/MILESTONES.md`](./roadmap/MILESTONES.md) — Key milestones and success metrics

### Competitive & Business
- [`competitive/CLOAKED_TEARDOWN.md`](./competitive/CLOAKED_TEARDOWN.md) — Competitive analysis vs Cloaked
- [`business/PRICING.md`](./business/PRICING.md) — Pricing tiers and strategy
- [`business/REVENUE_MODEL.md`](./business/REVENUE_MODEL.md) — Revenue streams and projections

### Design
- [`design/DESIGN_SYSTEM.md`](./design/DESIGN_SYSTEM.md) — Midnight Editorial theme spec
- [`design/REFERENCE_DASHBOARD.jsx`](./design/REFERENCE_DASHBOARD.jsx) — Reference dashboard implementation

### Ecosystem
- [`ecosystem/ECOSYSTEM_OVERVIEW.md`](./ecosystem/ECOSYSTEM_OVERVIEW.md) — Kova + VulnIQ + Phantom integration
